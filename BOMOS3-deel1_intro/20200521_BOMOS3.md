...
Deze concrete vragen waren 10 jaar geleden aanleiding tot het opbouwen van het Beheer- en OntwikkelModel voor Open Standaarden (BOMOS), met handreikingen voor een open invulling voor het beheer. Sindsdien is er rond BOMOS een heuze standaardisatie community ontstaan. Daardoor is BOMOS nu meer dan een model alleen. De doelstellingen van het BOMOS project zijn daarbij uitgebreid met:

* Het verzamelen en beschikbaar stellen van best practices 

* Het ondersteunen van standaardisatieprojecten
...
**Open standaard**  
Onder een ‘open standaard’ verstaan we een standaard die voldoet aan de volgende eisen (conform actieplan in Verbinding en het European Interoperability Framework):
...
### BOMOS als toets van het huidige beheerproce
...
TODO: HIER FIGUUR2 UIT BOMOS2I boekje pagina 10.
