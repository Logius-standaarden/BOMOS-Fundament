...
- [1. Woord van Dank](#1-woord-van-dank)
- [2. De 10 BOMOS statements](#2-de-10-bomos-statements)
- [3. Inleiding](#3-inleiding)
  - [3.1. Aanleiding](#31-aanleiding)
  - [3.2. Doel](#32-doel)
  - [3.3. Doelgroep](#33-doelgroep)
  - [3.4. Leeswijzer](#34-leeswijzer)
  - [3.5. Aanpak](#35-aanpak)
- [4. Context & Definities](#4-context--definities)
  - [4.1. Context: standaarden voor interoperabiliteit](#41-context-standaarden-voor-interoperabiliteit)
  - [4.2. Definities](#42-definities)
- [5. BOMOS gebruiken](#5-bomos-gebruiken)
  - [5.1. BOMOS als hulpmiddel voor verdere ontwikkeling van de beheerorganisaties](#51-bomos-als-hulpmiddel-voor-verdere-ontwikkeling-van-de-beheerorganisaties)
  - [5.2. BOMOS als hulpmiddel voor beheerorganisatie met het Implementatie instrument](#52-bomos-als-hulpmiddel-voor-beheerorganisatie-met-het-implementatie-instrument)
  - [5.3. BOMOS als achtergrondinformatie ter inspiratie](#53-bomos-als-achtergrondinformatie-ter-inspiratie)
  - [5.4. BOMOS als richtlijn](#54-bomos-als-richtlijn)
- [6. Het model: activiteiten voor ontwikkeling en beheer](#6-het-model-activiteiten-voor-ontwikkeling-en-beheer)
  - [6.1. Invulling verschilt per situatie](#61-invulling-verschilt-per-situatie)
  - [6.2. De activiteiten uit het model](#62-de-activiteiten-uit-het-model)
  - [6.3. Activiteiten en Rollen](#63-activiteiten-en-rollen)
- [7. De BOMOS activiteiten in vogelvlucht - Introductie in deel 2.](#7-de-bomos-activiteiten-in-vogelvlucht---introductie-in-deel-2)
- [8. Tot slot](#8-tot-slot)
...
## 4. Context & Definities


### 4.1. Context: standaarden voor interoperabiliteit
...
[https://www.iec.ch/about/globalreach/academia/pdf/academia_governments/handbook-standardisation_en.pdf](https://www.iec.ch/about/globalreach/academia/pdf/academia_governments/handbook-standardisation_en.pdf)
...
[http://www.semanticstandards.org](http://www.semanticstandards.org)
...
### 5.1. BOMOS als hulpmiddel voor verdere ontwikkeling van de beheerorganisaties 
...
### 5.2. BOMOS als hulpmiddel voor beheerorganisatie met het Implementatie instrument 

In sommige gevallen wil de BOMOS gebruiker meer sturing krijgen in het gebruik van BOMOS: dan is het Implementatie instrument in deel 4 uitermate geschikt om te gebruiken. Op basis van de fase van de levenscyclus waarin de standaard zich bevindt worden concrete activiteiten benoemd, en potentiële invullingen geschetst. 
...
### 5.3. BOMOS als achtergrondinformatie ter inspiratie
...
## 6. Het model: activiteiten voor ontwikkeling en beheer 
...
### 6.1. Invulling verschilt per situatie 
...
### 6.2. De activiteiten uit het model
...
### 6.3. Activiteiten en Rollen

NIEUW op basis van het NEN werk...
<p class="comment" style="color:red">
Is nog leeg! Suggestie: in te vullen door Erwin Folmer </p>

## 7. De BOMOS activiteiten in vogelvlucht - Introductie in deel 2. 
