...
- [5. LINKED DATA & ONTOLOGIEËN](#5-linked-data--ontologieën)
  ...
  - [5.2. Opkomst van Linked Data](#52-opkomst-van-linked-data)
    ...
    - [5.2.3. De FAIR-beweging](#523-de-fair-beweging)
  ...
  - [5.4. Impact op standaardisatie en beheer](#54-impact-op-standaardisatie-en-beheer)
    ...
    - [5.4.2. Training en opleiding](#542-training-en-opleiding)
    - [5.4.3. Een (tussen)weg kiezen](#543-een-tussenweg-kiezen)
    - [5.4.4. Doorontwikkelen](#544-doorontwikkelen)
    - [5.4.5. Gebruiksanalyse](#545-gebruiksanalyse)
  - [5.5. Hulpmiddelen](#55-hulpmiddelen)
    - [5.5.1. Pool Party](#551-pool-party)
    - [5.5.2. Protégé](#552-protégé)
    - [5.5.3. Semantic Treehouse](#553-semantic-treehouse)
    - [5.5.4. Topbraid Composer](#554-topbraid-composer)
- [6. KWALITEITSBELEID EN BENCHMARKING](#6-kwaliteitsbeleid-en-benchmarking)
  - [6.1. Kwaliteit van standaarden](#61-kwaliteit-van-standaarden)
    - [6.1.1. Wat vinden de standaardisatieorganisaties zelf van de kwaliteit?](#611-wat-vinden-de-standaardisatieorganisaties-zelf-van-de-kwaliteit)
...
| [Semantic Treehouse](https://www.semantic-treehouse.nl/)                     | TNO                                    | Publicatie- en beheeromgeving voor gezamelijke datamodellen                           |
...
|                                                |                                                 |
<p class="comment" style="color:red">Hier nog een vorobeeld van Logius?</p>
