 ...
 * For example 'vertical' information exchange for a specific sector: Geo-domain, Education, Healthcare, etcetera.
 * For example 'horizontal': information exchange for a specific function: Purchasing, Invoicing, etcetera.
